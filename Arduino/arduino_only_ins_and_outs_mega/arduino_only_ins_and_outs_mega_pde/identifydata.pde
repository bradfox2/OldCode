int identifydata(int x){  //accepts a binary number and returns a corresponding number that matches into state["blah"] to match to a human string
  ...
  switch(x){
  case 0000000000 :  // see if binary number matches zero
