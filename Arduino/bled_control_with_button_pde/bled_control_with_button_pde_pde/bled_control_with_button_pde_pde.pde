    ...
    while (client.connected()) {
      if (client.available()) {
...

        {
          ...
          client.println("<form method=get><input type=radio name=L value=1>L<br><input type=radio name=L value=2>C<br><input type=radio name=L value=3>N<br><input type=submit value=submit></form>");
          client.println("<br />");
