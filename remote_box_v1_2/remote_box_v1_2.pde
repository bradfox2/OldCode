...
#define input_table 5
#define output_table 35

struct input{
  char input_state_name[20];
  unsigned long  input_pin_state;
} inputdb;

struct output{
  char output_state_name[20];
  unsigned long output_pin_state;
} outputdb;
...
prog_char state_35[] PROGMEM = "<h1> Tiny Logic Controller</h1>";
prog_char state_36[] PROGMEM = "<h4>Data Display Page</h4>|";
prog_char state_37[] PROGMEM = "<table border=""1""><tr><td>";
prog_char state_38[] PROGMEM = "<h3>Mode Change Form:</h3><p><form name=""modeselect"" action=""/form/modechange"" method=""POST"">";
//prog_char state_38[] PROGMEM = "
prog_char state_39[] PROGMEM = "<select name = ""modename"">";

prog_char state_40[] PROGMEM = "<option>Test1</option>";
prog_char state_41[] PROGMEM = "<option>Test2</option>";
prog_char state_42[] PROGMEM = "<input type=""submit"" value=""Apply Mode"" /></select></form> ";
...
//added in 1.1
prog_char state_49[] PROGMEM ="<tr><td>  <h3> IP Change Form</h3><p><form name=""input"" action=""/form/ipchange"" method=""post""><input type=""IP"" name=""firstSector"" size = ""1"" value="""" >."; 
...
prog_char state_53[] PROGMEM ="<tr><td><h3>Relay Toggle</h3><form method=""get"" action=""/form/relay"" name=""relay""><input name=""relay"" value=""on"" type=""radio"">Relay On<br>";
...
void setup() {
  ...
  //database code//
  db.create(input_table, sizeof(input_table));
  db.create(output_table, sizeof(output_table));
  db.open(input_table);
  db.open(output_table);
  //db.append(DB_REC output_rec);
}
